...
fit.sarima.auto.sales <- auto.arima(df_semana$sales, seasonal = T)
summary(fit.sarima.auto.sales)
checkresiduals(fit.sarima.auto.sales)

# Criação do modelo com base em 'revenue' --------------------------------------
fit.sarima.auto.revenue <- auto.arima(df_semana$revenue, seasonal = T)
summary(fit.sarima.auto.revenue)
checkresiduals(fit.sarima.auto.revenue)
