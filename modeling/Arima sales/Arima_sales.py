# -*- coding: utf-8 -*-
"""
Created on Thu Jul 20 20:46:38 2023
...
for store_id in valores_unicos:
    ...
    train_data = store_data.loc[train_start_week:train_end_week, 'sales']
    time_train_data = store_data.loc[train_start_week:train_end_week,'continuous_week_number']
    test_data = store_data.loc[test_start_week:test_end_week, 'sales']
    ...
    plt.plot(store_data['continuous_week_number'], store_data['sales'], label='Dados Originais')
